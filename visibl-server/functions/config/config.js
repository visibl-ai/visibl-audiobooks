...
const WAVESPEED_WEBHOOK_SECRET = defineSecretOrString("WAVESPEED_WEBHOOK_SECRET");
const GROQ_API_KEY = defineSecretOrString("GROQ_API_KEY");
const TOGETHER_API_KEY = defineSecretOrString("TOGETHER_API_KEY");
...
const COVER_ART_PLACEHOLDER = defineString("COVER_ART_PLACEHOLDER", {default: "https://imagedelivery.net/tQttKO0JZXPihTOH_rMepA/d02af454-4550-45e9-4456-238be5047c00/public"});
